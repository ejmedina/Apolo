		...
		<div class="body">
			...
			<g:form method="post"
				...
				<input type="hidden" name="version"
					value="${vehicleInstance?.version}" />
				<div class="dialog">
					<table>
						<tbody>
							
                         <p>
					<label for="brand"><g:message code="vehicle.brand.label" default="Brand" />
					</label>
                         ...
                         <p>
					<label for="cargo"><g:message code="vehicle.cargo.label" default="Cargo" />
					</label>
                         ...
                         <p>
					<label for="foodAble"><g:message code="vehicle.foodAble.label" default="Food Able" />
					</label>
                         ...
                         <p>
					<label for="freezerAble"><g:message code="vehicle.freezerAble.label" default="Freezer Able" />
					</label>
                         ...
                         <p>
					<label for="fuelType"><g:message code="vehicle.fuelType.label" default="Fuel Type" />
					</label>
                         ...
                         <p>
					<label for="height"><g:message code="vehicle.height.label" default="Height" />
					</label>
                         ...
                         <p>
					<label for="lenght"><g:message code="vehicle.lenght.label" default="Lenght" />
					</label>
                         ...
                         <p>
					<label for="licenceRequired"><g:message code="vehicle.licenceRequired.label" default="Licence Required" />
					</label>
                         ...
                         <p>
					<label for="model"><g:message code="vehicle.model.label" default="Model" />
					</label>
                         ...
                         <p>
					<label for="status"><g:message code="vehicle.status.label" default="Status" />
					</label>
                         ...
                         <p>
					<label for="weight"><g:message code="vehicle.weight.label" default="Weight" />
					</label>
                         ...
                         <p>
					<label for="wide"><g:message code="vehicle.wide.label" default="Wide" />
					</label>
                         ...
                         <p>
					<label for="year"><g:message code="vehicle.year.label" default="Year" />
					</label>
