		...
		<div class="body">
			...
			<g:form method="post"
				...
				<input type="hidden" name="version"
					value="${driverInstance?.version}" />
				<div class="dialog">
					<table>
						<tbody>
							
                         <p>
					<label for="address"><g:message code="driver.address.label" default="Address" />
					</label>
                         ...
                         <p>
					<label for="cuil"><g:message code="driver.cuil.label" default="Cuil" />
					</label>
                         ...
                         <p>
					<label for="dni"><g:message code="driver.dni.label" default="Dni" />
					</label>
                         ...
                         <p>
					<label for="email"><g:message code="driver.email.label" default="Email" />
					</label>
                         ...
                         <p>
					<label for="firstName"><g:message code="driver.firstName.label" default="First Name" />
					</label>
                         ...
                         <p>
					<label for="lastName"><g:message code="driver.lastName.label" default="Last Name" />
					</label>
                         ...
                         <p>
					<label for="middleName"><g:message code="driver.middleName.label" default="Middle Name" />
					</label>
                         ...
                         <p>
					<label for="mobile"><g:message code="driver.mobile.label" default="Mobile" />
					</label>
                         ...
                         <p>
					<label for="phone"><g:message code="driver.phone.label" default="Phone" />
					</label>
                         ...
                         <p>
					<label for="status"><g:message code="driver.status.label" default="Status" />
					</label>
